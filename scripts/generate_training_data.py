...
FILLERS: dict[str, list[str]] = {
    "city": [
        ...
        "Dubai", "Chicago", "the city", "here", "Berlin", "Singapore",
        "Los Angeles", "Toronto", "Mexico City",
    ],
    "topic": [
        "AI", "technology", "sports", "politics", "movies", "market",
        "science", "space", "climate change", "cryptocurrency", "fashion",
        "health", "music", "gaming", "finance",
    ],
    "person": [
        "Albert Einstein", "Elon Musk", "Marie Curie", "Steve Jobs",
        "the president", "Nikola Tesla", "Ada Lovelace", "Alan Turing",
        "Barack Obama", "Mahatma Gandhi",
    ],
    "concept": [
        "quantum physics", "machine learning", "black holes", "blockchain",
        "photosynthesis", "relativity", "DNA", "cloud computing",
        "neural networks", "evolution",
    ],
    "task": [
        "call mom", "buy groceries", "finish report", "pay bills",
        "walk the dog", "book tickets", "read a book", "reply to emails",
        "exercise", "prepare presentation",
    ],
    "time": [
        "3 PM", "tomorrow morning", "in an hour", "tonight",
        "next week", "at noon", "in 30 minutes", "before dinner",
        "at 9 AM", "this evening",
    ],
    "math": [
        "2+2", "15 * 6", "100 / 4", "sqrt(144)", "50% of 200",
        "5^3", "17 * 13", "1000 - 250", "45 + 89", "360 / 12",
    ],
    "note": [
        "meeting notes from Monday", "grocery list", "project ideas",
        "personal journal entry", "code snippet for later",
    ],
    "app": [
        "Chrome", "Notepad", "VS Code", "Spotify", "Calculator",
        "Teams", "Word", "Excel", "Discord", "Terminal",
    ],
    "minutes": ["5", "10", "15", "30", "60", "120"],
    "url": [
        "https://example.com", "https://news.ycombinator.com",
        "https://python.org", "https://wikipedia.org",
