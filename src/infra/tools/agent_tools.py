...
def get_agent_tools() -> list:
    ...
    async def schedule_future_task(minutes: int, prompt: str, session_id: str) -> str:
        ...
        try:
            ...
            logger.error(f"Cannot import scheduler: {e}")
            return "Failed to access system scheduler."

        run_date = datetime.now() + timedelta(minutes=minutes)
        
        async def _execute_proactive_task(task_prompt: str, s_id: str):
            ...
            try:
                ...
                logger.error(f"Failed to execute proactive task: {e}")
        ...
        try:
            ...
            logger.error(f"Failed to schedule future task: {e}")
